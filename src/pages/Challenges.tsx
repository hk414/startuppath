        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle className="flex items-center gap-2">
              ...
              {t('challenges.authDialog.title')}
            </AlertDialogTitle>
            <AlertDialogDescription className="space-y-4 pt-4">
              <p className="text-base">
                {t('challenges.authDialog.description')}
              </p>
              <div className="flex gap-3">
                <Button onClick={handleAuthRedirect} className="flex-1">
                  {t('challenges.authDialog.signIn')}
                </Button>
                <Button variant="outline" onClick={() => navigate('/')} className="flex-1">
                  {t('challenges.authDialog.goBack')}
                </Button>
              </div>
            </AlertDialogDescription>
          </AlertDialogHeader>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-6 bg-gradient-card border border-border rounded-2xl px-6 py-3 shadow-medium">
              <div className="text-center">
                <div className="text-xs text-muted-foreground mb-1">{t('challenges.level')}</div>
                <div className="text-lg font-bold text-primary uppercase">{userStats.level}</div>
              </div>
              <div className="w-px h-10 bg-border" />
              <div className="text-center">
                <div className="text-xs text-muted-foreground mb-1">{t('challenges.totalXP')}</div>
