...
const translations = {
  en: {
    ...
    hero: {
      ...
      title3: "Accelerate Innovation",
      subtitle: "Transform every decision, pivot, and breakthrough into",
      subtitleBold: "actionable insights",
      subtitleEnd: "that power the entire entrepreneurial ecosystem.",
      ctaStart: "Start Your Journey",
      ctaExplore: "Explore Features",
      stats: {
        startups: "Startups Tracked",
        pivots: "Pivots Documented",
        mentors: "Mentors Active",
      }
    },
    challenges: {
